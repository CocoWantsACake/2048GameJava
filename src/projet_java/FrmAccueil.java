 ...
 * constructeur FrmAccueil(String, FrmJeu)
 * constructeur FrmAccueil(String)
 * ### ---------------------------- ###
 * ###      getters et setters      ###
 * ### ---------------------------- ###
 * procedure setScoreMax(int)
 * fonction getScoreMax() [return int]
 * procedure setSaFrmJeu(FrmJeu)
 * procedure setMeilleurScore()
 * ### ---------------------------- ###
 * ###       autres methodes        ###
 * ### ---------------------------- ###
 * procedure initComponents()
 * procedure btnQuitterActionPerformed(java.awt.event.ActionEvent)
 * procedure btnpartieActionPerformed(java.awt.event.ActionEvent)
 * procedure btnPartieIAActionPerformed(java.awt.event.ActionEvent)
 */
...
public class FrmAccueil extends javax.swing.JFrame {
	...
	// Declaration des composants de la fenetre
	...
	private void initComponents() { // procedure appelee par le constructeur pour initialiser la form
        ...
        // ajout des listeners sur les differents boutons
        ...
        //Le code ci-dessous a ete genere automatiquement grace au concepteur d'interfaces Java NetBeans
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(40, 40, 40)
                        .addComponent(lblMeilleurScore)
                        .addGap(18, 18, 18)
                        .addComponent(lblScore))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(146, 146, 146)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnpartie, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
